...
public class TestRMI {
	...
	public void testGetAll() {
		try {
			...
			assertEquals("Projectname2", projectMethod.getAll().get(1)
					.getName());
		} catch (RemoteException e) {
			e.printStackTrace();
		}
	...
	public void testGetByProperty() {
		try {
			assertEquals("Projectname2",
					projectMethod.getByProperty("street", "Street2").get(0)
							.getName());
			assertEquals("Nachname2",
					gcEmployeeMethod.getByProperty("firstname", "Firstname2")
							.get(0).getLastname());
		} catch (RemoteException e) {
			e.printStackTrace();
		}
	...
	public void testGetByRelation() {
		try {
			assertEquals("Issue2", issueMethod.getByRelation(Project.class, 2)

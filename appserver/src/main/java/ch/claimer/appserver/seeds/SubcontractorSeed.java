...
/**
 * In der SubcontractorSeed-Klasse werden die Subunternehmer mit den Adressen
 * und Kontaktdaten in die Datenbank geschrieben. Die Klasse erbt von der Klasse
 * Seed und setzt Subcontractor als Typ-Variable.
 * 
...
public class SubcontractorSeed extends Seed<Subcontractor> {
	...
	public SubcontractorSeed() {
		this.repository = new EclipseLinkRepository<Subcontractor>(
				Subcontractor.class);

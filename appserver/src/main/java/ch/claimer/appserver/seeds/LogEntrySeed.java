...
/**
 * In der LogEntry-Klasse werden die Beschreibungen einer Änderung an einem
 * Projekt oder Mangel in die Datenbank geschrieben. Die Klasse erbt von der
 * Klasse Seed und setzt LogEntry als Typ-Variable.
 * 

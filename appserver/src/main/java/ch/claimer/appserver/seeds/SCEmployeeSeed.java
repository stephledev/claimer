 ...
 * erstellt und in die Datenbank geschrieben. Die Klasse erbt von der Klasse
 * Seed und setzt SCEmployee als Typ-Variable.
 * 
...
public class SCEmployeeSeed extends Seed<SCEmployee> {
	...
	public SCEmployeeSeed() {
		this.repository = new EclipseLinkRepository<SCEmployee>(
				SCEmployee.class);
	...
	public void setup() {
		...
		SCEmployee1.setSubcontractor((Subcontractor) seeds.get("Subcontractor")
				.get(0));
		...
		SCEmployee2.setSubcontractor((Subcontractor) seeds.get("Subcontractor")
				.get(1));
		...
		SCEmployee3.setSubcontractor((Subcontractor) seeds.get("Subcontractor")
				.get(2));
		...
		SCEmployee4.setSubcontractor((Subcontractor) seeds.get("Subcontractor")
				.get(3));

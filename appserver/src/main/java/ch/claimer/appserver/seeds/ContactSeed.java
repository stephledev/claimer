...
public class ContactSeed extends Seed<Contact> {
	...
	public void setup() {
		...
		Contact1.setSubcontractor((Subcontractor) Seed.seeds.get("Subcontractor").get(0));
		...
		Contact2.setSubcontractor((Subcontractor) Seed.seeds.get("Subcontractor").get(1));
		...
		Contact3.setSubcontractor((Subcontractor) Seed.seeds.get("Subcontractor").get(2));
		...
		Contact4.setSubcontractor((Subcontractor) Seed.seeds.get("Subcontractor").get(3));
		...
		Contact5.setSubcontractor((Subcontractor) Seed.seeds.get("Subcontractor").get(4));
